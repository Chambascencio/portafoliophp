...
<html>
<head>
	<title>Rene Salvador Ascencio - graficos</title>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	<link rel="stylesheet" href="js/bootstrap.min.js"></script>
...
<body>
<div class="container">
	<h1 class="page-header text-left">Graficos con PHP</h1>
<div class="row">
		...
		<div class="col-md-10">
            ...
            <div class="box-header with-border">
            	<?php
					       $year = date('Y');
            	?>
              <h3 class="box-title">Informe ventas (<?php echo $year-1; ?> vs <?php echo $year; ?>)</h3>
